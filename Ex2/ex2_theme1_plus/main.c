...
int main(){
    ...
    /*ΒΗΜΑ 2 Δημιουργία μονοδιάστατου πίνακα με δομες 53 θέσεων */
    struct seat_info bus_table[MAX_CAP];

    /*ΒΗΜΑ 3 Αρχικοποίηση του  πίνακα με τις δομες seat_info*/
    InitBusTable(bus_table, MAX_CAP);


    /*ΒΗΜΑ 4 read από το αρχείο bus.txt */
    read_file(bus_table);
            ...
            if ( chr != '\n'){
                ...
                if (line_n == 0){
                   ...
                   // printf("\nPassengers list / Seat  / Tel. Num:\n");
                    ...
                    /* Άλλος Τρόπος με τον οποίο το τηλέφωνο εισάγεται ως double και στη συνέχεια γίνονται μετασχηματισμοί
